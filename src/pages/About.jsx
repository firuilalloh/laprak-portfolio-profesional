  ...
  return (
    <section id="about">
      <div className="min-h-screen bg-gray-900 text-white flex flex-col justify-center px-4">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-10 w-full max-w-6xl mx-auto py-16">
          <div className="flex flex-col justify-center items-center md:items-start md:justify-start order-2 md:order-1 mt-15 text-center md:text-left">
            <h1 className="text-5xl font-bold mb-3 tracking-tight">Mochammad Fafirru Ilalloh</h1>
            <h2 className="text-2xl text-gray-400 font-light mb-2">Frontend Developer</h2>
            <h2 className="text-2xl text-sky-400 mb-4 font-medium">1 Year & 9 Month Experience</h2>
